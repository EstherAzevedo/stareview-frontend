<script setup>
import { ref } from 'vue'
import logo from '../assets/logo_vertical_bg_dark.svg'
    ...
    <div class="flex-1 relative overflow-hidden bg-white">
      ...
      <div class="relative z-10 flex flex-col justify-center items-start h-full px-20 text-white">
        <div class="flex flex-col items-start gap-6 max-w-md">
          ...
          <img :src="logo" alt="logo" class="w-[260px]" />
          <div>
      ...
      <div class="flex-1 flex justify-center items-center bg-white">
        ...
        <main class="pt-10 pb-20 px-8 w-[350px] h-[430px] rounded-2xl shadow-xl border border-red-400">
          ...
          <form class="space-y-4" @submit.prevent="handleLogin" novalidate>
            <div class="flex flex-col">
              ...
              <input id="email" v-model="email" v-bind="emailAttrs" type="email" :aria-invalid="!!errors.email" aria-describedby="email-error" placeholder="seuemail@email.com" 
            ...
            <div class="flex flex-col">
              ...
              <input id="password" v-model="password" v-bind="passwordAttrs" type="password" placeholder="********" autocomplete="current-password"
